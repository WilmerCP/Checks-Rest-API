...
workers.log = function(originalCheckdata,checkOutcome,state,corresponde,timeOfCheck){
    ...
    _logs.append(filename,logString,(err)=>{
        ...
        if(!err){
            ...
            console.log('Successfully logged data to file');
...
workers.rotateLogs = function(){
    ...
    _logs.list(false,(err,logs)=>{
        ...
        if(!err && logs && logs.length > 0){
                    ...
                    if(!err){
                        ...
                        _logs.truncar(logFile + '.log',(err)=>{
                            ...
                            if(!err){
                                ...
                                console.log('Se han rotado los logs satisfactoriamente');

                            }else{

                                console.log('Error al borrar el contenido de un archivo de logs');
                                console.log(err);
                        ...
                        console.log('Error al comprimir un archivo:' + err);
            ...
            console.log("Aviso: No se encontraron logs para comprimir");
